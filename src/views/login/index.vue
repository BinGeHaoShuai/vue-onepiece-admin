  ...
  <div class="login-container">
    <div class="img">
      ...
      >
        ...
        ></path>
        <circle cx="710.482" cy="132.435" r="24.561" fill="#a0616a"></circle>
        <path
          fill="#5392f0"
    ...
    <div class="form-container">
      ...
      <el-form :model="formMsg" size="large" style="min-width: 300px">
        ...
        <div class="form_check_form">
          <el-checkbox v-model="remenberPwd">记住密码</el-checkbox>
          <el-link href="https://element-plus.org" target="_blank" type="primary">忘记密码?</el-link>
        </div>
